 ...
 */
public class TranslationCodeTableFilterWrapper extends
        CodeTableFilterWrapper<TranslationCodeTable, StatisticalClassification> {
    ...
    @Override
    protected TranslationCodeTable createTable() {
        return new TranslationCodeTable();
    }

    @Override
    protected void initTable(EventBus eventbus, TranslationCodeTable table, StatisticalClassification entity) {
        // Do nothing
    }
