...
public class CustomHierarchicalContainer extends IndexedContainer implements
    ...
    public boolean setParent(Object itemId, Object newParentId) {
        ...
        // NOTE containsId(newParentId) will only check visible items and we need to check all
        if (!getAllItemIds().contains(newParentId) || noChildrenAllowed.contains(newParentId)) {
            return false;
        }
