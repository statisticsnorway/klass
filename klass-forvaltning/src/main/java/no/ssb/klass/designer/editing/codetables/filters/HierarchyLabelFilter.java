 ...
 */
public class HierarchyLabelFilter implements Container.Filter {
    ...
    public HierarchyLabelFilter(CustomHierarchicalContainer container, Object propertyId, String filterString,
    ...
    public boolean passesFilter(Object itemId, Item item) {
        ...
        String labelValue = ((Label) propertyValue).getValue();
        final String value = ignoreCase ? labelValue.toLowerCase() : labelValue.toString();
        if (onlyMatchPrefix) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof HierarchyLabelFilter)) {
            return false;
        }
        final HierarchyLabelFilter o = (HierarchyLabelFilter) obj;
    ...
    /**
     * Returns true if the filter only applies to the beginning of the value string, false for any location in the
     * value.
     *
     * Note: this method is intended only for implementations of lazy string filters and may change in the future.
     *
