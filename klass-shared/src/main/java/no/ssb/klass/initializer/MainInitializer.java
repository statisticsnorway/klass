...
/**
 * Populates an empty database with required data such as classification families and statistical
 * units. And creates classifications migrated from Stabas, etc.
 *
 * <p>Has Ordered.HIGHEST_PRECEDENCE so that it is run before the SearchIndexPopulator. Hence any
 * created (migrated) classifications will later be indexed.
 */
@Service
