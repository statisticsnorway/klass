...
/**
 * Some classifications in Stabas have names that deviates from the standard where classifications
 * shall start with 'Standard for ...'. All Stabas classifications whose names deviates are mapped
 * to a new name that follows the new standard.
 */
public class ClassificationNameMapper {
  ...
  /**
   * Maps an incorrect classification name in Stabas to a correct classification name to be used by
   * Klass.
   *
  ...
  public Translatable mapClassificationName(Translatable classificationName) {
    return classificationNameMap.getOrDefault(
        classificationName.getString(Language.NB), classificationName);
  }
  ...
  private Map<String, Translatable> createClassificationNameMap() {
    return ImmutableMap.<String, Translatable>builder()
        ...
        .put(
            ...
            createTranslatable("Standard for kjønn", "Standard for kjønn", "Classification of sex"))
        .put(
        ...
        .put(
            "Standard av renseprinsipper for store avløpsanlegg (>50 pe)",
            createTranslatable(
        ...
        .put(
            ...
            createTranslatable(
                "Standard for CPA koder", "Standard for CPA kodar", "Classification of CPA codes"))
        .put(
