...
public class ClassificationNameMapper {
    ...
    /**
     * Maps an incorrect classification name in Stabas to a correct classification name to be used
     * by Klass.
     *
     * @param classificationName
     * @return a corrected classificationName or same as input classificationName if no mapping
     *     exists
     */
