...
public class ClassificationVersion extends StatisticalClassification {
   ...
   * exists for a given year, the year is prefixed with the month (Exs: Bydeler 03-2014), note that
   * if given version contains an alias value then this will be returned instead.
   *
