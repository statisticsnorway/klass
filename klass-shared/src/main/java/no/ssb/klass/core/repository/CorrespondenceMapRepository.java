...
public interface CorrespondenceMapRepository extends CrudRepository<CorrespondenceMap, Long> {
    ...
    /**
     * Finds all CorrespondenceMaps whose source or target references a classificationItem in
     * provided statistical classification
     *
     ...
     *
     * @param classification StatisticalClassification with items to match
     * @param deletedClassificationItems Since deletedItems is a transient collection you will have
     *     to provide it manually here
     * @return list of CorrespondenceMaps whose source or target references one or more
