...
public class Level extends BaseEntity {
  ...
  public Level(int levelNumber) {
    this(
        levelNumber,
        new Translatable("Nivå " + levelNumber, "Nivå " + levelNumber, "Level " + levelNumber));
  }
  ...
  /**
   * Not public since clients should add classificationItems through owning version/variant. This so
   * that version/variant can enforce no duplicated codes.
   */
