...
public class Subscriber extends BaseEntity {
  ...
  public boolean removeSubscription(ClassificationSeries classification) {
    ...
    boolean deleted =
        subscriptions.removeIf(
            t -> Objects.equals(t.getClassificationSeries().getId(), classification.getId()));
    if (!deleted) {
      throw new ClientException(
        ...
        .orElseThrow(
            () ->
                new IllegalArgumentException(
                    "No subscription for classification: " + classification.getId()))
  ...
  public boolean subscriptionExist(ClassificationSeries classification) {
    return subscriptions.stream()
        .anyMatch(t -> Objects.equals(t.getClassificationSeries().getId(), classification.getId()));
  }
