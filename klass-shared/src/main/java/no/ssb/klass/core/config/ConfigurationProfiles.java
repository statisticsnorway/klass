...
public final class ConfigurationProfiles {
  ...
  /** Profile for beans that should only be activated for the Klient/frontend application */
  ...
  /**
   * Profile to be used during development, imports only a small number of classifications from
   * Stabas
   */
