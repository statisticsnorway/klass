...
public final class TestUtil {
    ...
    public static ClassificationSeries createClassification(String name) {
        return new ClassificationSeries(
                Translatable.create(name, Language.getDefault()),
                Translatable.create("description", Language.getDefault()),
                false,
                Language.NB,
    ...
    public static ClassificationSeries createClassification(
            String nameNO,
            String nameNN,
            String nameEN,
        ...
        return new ClassificationSeries(
                new Translatable(nameNO, nameNN, nameEN),
                new Translatable(descriptionNO, descriptionNN, descriptionEN),
                false,
                Language.NB,
                ClassificationType.CLASSIFICATION,
                createUser());
    ...
    public static ClassificationSeries createClassificationWithId(
    ...
    public static ClassificationVersion createClassificationVersionWithTable(
            long id, DateRange dateRange, String name) {
    ...
    public static ClassificationVariant createClassificationVariant(String name, User user) {
        ClassificationVariant variant =
                new ClassificationVariant(Translatable.create(name, Language.getDefault()), user);
    ...
    public static ConcreteClassificationItem createClassificationItem(
            String code, String officialName) {
        return createClassificationItem(code, officialName, null);
    }

    public static ConcreteClassificationItem createClassificationItem(
            String code, String officialName, String shortName) {
        return new ConcreteClassificationItem(
                code,
                Translatable.create(officialName, Language.getDefault()),
                Translatable.create(shortName, Language.getDefault()));
    }

    public static ConcreteClassificationItem createClassificationItem(
            String code, String officialName, String shortName, String notes) {
        return new ConcreteClassificationItem(
                code,
                Translatable.create(officialName, Language.getDefault()),
                Translatable.create(shortName, Language.getDefault()),
                Translatable.create(notes, Language.getDefault()));
    }

    public static ReferencingClassificationItem createReferencingClassificationItem(
    ...
    public static ClassificationFamily createClassificationFamily(String name) {
        return new ClassificationFamily(
                Translatable.create(name, Language.getDefault()), "ikon_arbeid.svg");
    }

    public static CorrespondenceTable createCorrespondenceTable(
            ClassificationVersion source, ClassificationVersion target) {
        return createCorrespondenceTable("description", source, target);
    }

    public static CorrespondenceTable createCorrespondenceTable(
            String description, ClassificationVersion source, ClassificationVersion target) {
    ...
    public static DateRange anyDateRange() {
        return DateRange.create(
                TimeUtil.createDate("2012-01-01"), TimeUtil.createDate("2015-01-01"));
    }

    public static ClassificationType oppositeClassificationType(
            ClassificationType classificationType) {
        checkNotNull(classificationType);
        return classificationType == ClassificationType.CLASSIFICATION
                ? ClassificationType.CODELIST
                : ClassificationType.CLASSIFICATION;
    }
}
