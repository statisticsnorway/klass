...
public final class TestDataProvider {
  ...
  public static ClassificationSeries createClassificationKommuneinndeling() {
    ...
    versionFuture.addClassificationItem(
        TestUtil.createClassificationItem("0101", "Halden"), levelFuture.getLevelNumber(), null);
    versionFuture.addClassificationItem(
        TestUtil.createClassificationItem("0104", "Moss"), levelFuture.getLevelNumber(), null);
    versionFuture.addClassificationItem(
        TestUtil.createClassificationItem("0301", "Oslo"), levelFuture.getLevelNumber(), null);
    versionFuture.addClassificationItem(
    ...
    ClassificationVersion version2014 =
        TestUtil.createClassificationVersion(DateRange.create("2014-01-01", TEN_YEARS_LATER_DATE));
    ...
    version2008.addClassificationItem(
        TestUtil.createClassificationItem("0101", "Halden"), level2008.getLevelNumber(), null);
    version2008.addClassificationItem(
        TestUtil.createClassificationItem("0104", "Moss"), level2008.getLevelNumber(), null);
    version2008.addClassificationItem(
        TestUtil.createClassificationItem("0301", "Oslo"), level2008.getLevelNumber(), null);
    version2008.addClassificationItem(
        TestUtil.createClassificationItem("1739", "Røyrvik"), level2008.getLevelNumber(), null);
    version2008.addClassificationItem(
        TestUtil.createClassificationItem("1939", "Storfjord"), level2008.getLevelNumber(), null);
  ...
  public static CorrespondenceTable createAndAddChangeCorrespondenceTableFutureVersion(
    ...
    correspondenceTable.addCorrespondenceMap(
        new CorrespondenceMap(kommuneFutureDate.findItem("5043"), kommune2014.findItem("1739")));
    return correspondenceTable;
  }

  public static ClassificationSeries createClassificationBydelsinndeling() {
    ClassificationSeries classification =
        TestUtil.createClassification(BYDELSINNDELING_NAVN_NO, BYDELSINNDELING_BESKRIVELSE_NO);
    ...
    versionFuture.addClassificationItem(
        ...
        null);
    versionFuture.addClassificationItem(
        TestUtil.createClassificationItem("030105", "Frogner"), levelFuture.getLevelNumber(), null);
  ...
  public static ClassificationSeries createFamiliegrupperingCodelist(User user) {
    ClassificationSeries classification =
        TestUtil.createCodelist(FAMILIEGRUPPERING_NAVN_NO, FAMILIEGRUPPERING_BESKRIVELSE_NO);
  ...
  public static ClassificationSeries createBadmintonCodelist(User user, User user1, User user2) {
    ...
    version.addLevel(level);
    version.addClassificationItem(
        TestUtil.createClassificationItem("0.1.1", "Fjærballer pro"), level.getLevelNumber(), null);
    ClassificationVariant variant =
        TestUtil.createClassificationVariant("Variant - Tilleggsinndeling for baller", user1);
    ...
    variant.addClassificationItem(
        TestUtil.createClassificationItem("BA", "Tennisball med fjær"), 2, variant.findItem("B"));
    variant.addClassificationItem(
        TestUtil.createClassificationItem("BB", "Tennisball pro"), 2, variant.findItem("B"));
    version.addClassificationVariant(variant);
    ClassificationVariant variant2 =
        TestUtil.createClassificationVariant("Variant - Tilleggsinndeling for racketer", user2);
  ...
  public static CorrespondenceTable createAndAddCorrespondenceTableTableFutureVersion(
    ...
    for (String bydelCode : Arrays.asList("030101", "030102", "030103")) {
      correspondenceTable.addCorrespondenceMap(
          new CorrespondenceMap(kommuneFuture.findItem("0301"), bydelFuture.findItem(bydelCode)));
    }
