...
public final class TestDataProvider {
    ...
    public static  final String TEN_YEARS_LATER =  (new GregorianCalendar().get(Calendar.YEAR)+10)+"";
    public static  final String TEN_YEARS_LATER_DATE =  (new GregorianCalendar().get(Calendar.YEAR)+10) + "-01-01";
    public static  final String FIFTEEN_YEARS_LATER_DATE =  (new GregorianCalendar().get(Calendar.YEAR)+15) + "-01-01";
    public static  final String TWENTY_YEARS_LATER_DATE =  (new GregorianCalendar().get(Calendar.YEAR)+20) + "-01-01";
    ...
    public static ClassificationSeries createClassificationKommuneinndeling() {
        ...
        versionFuture.addClassificationItem(TestUtil.createClassificationItem("0101", "Halden"), levelFuture.getLevelNumber(),
                null);
        versionFuture.addClassificationItem(TestUtil.createClassificationItem("0104", "Moss"), levelFuture.getLevelNumber(),
                null);
        versionFuture.addClassificationItem(TestUtil.createClassificationItem("0301", "Oslo"), levelFuture.getLevelNumber(),
                null);
        versionFuture.addClassificationItem(TestUtil.createClassificationItem("5043", "Raarvihke Røyrvik"), levelFuture
                .getLevelNumber(), null);
        versionFuture.addClassificationItem(TestUtil.createClassificationItem("1939", "Omasvuotna Storfjord Omasvuonon"),
    ...
    public static CorrespondenceTable createAndAddChangeCorrespondenceTableFutureVersion(
            ClassificationSeries kommuneClassification) {
        ClassificationVersion kommuneFutureDate = kommuneClassification.getClassificationVersions().get(0);
        ClassificationVersion kommune2014 = kommuneClassification.getClassificationVersions().get(1);
        CorrespondenceTable correspondenceTable = TestUtil.createCorrespondenceTable(kommuneFutureDate, kommune2014);
        kommuneFutureDate.addCorrespondenceTable(correspondenceTable);
        correspondenceTable.addCorrespondenceMap(new CorrespondenceMap(kommuneFutureDate.findItem("5043"), kommune2014
                .findItem("1739")));
        return correspondenceTable;
    }
    ...
    public static ClassificationSeries createClassificationBydelsinndeling() {
        ...
        Level levelFuture = TestUtil.createLevel(1);
        versionFuture.addLevel(levelFuture);
        versionFuture.addClassificationItem(TestUtil.createClassificationItem("030101", "Gamle Oslo"), levelFuture.getLevelNumber(),
                null);
        versionFuture.addClassificationItem(TestUtil.createClassificationItem("030102", "Grünerløkka"), levelFuture
                .getLevelNumber(), null);
        versionFuture.addClassificationItem(TestUtil.createClassificationItem("030103", "Sagene ny"), levelFuture.getLevelNumber(),
                null);
        versionFuture.addClassificationItem(TestUtil.createClassificationItem("030104", "St. Hanshaugen"), levelFuture
                .getLevelNumber(), null);
        versionFuture.addClassificationItem(TestUtil.createClassificationItem("030105", "Frogner"), levelFuture.getLevelNumber(),
                null);
    ...
    public static ClassificationVersion createFamiliegrupperingFutureVersion(User user) {
        ...
        version.addClassificationItem(TestUtil.createClassificationItem("1.1.1", "Enpersonfamilie, person under 30 år"),
                level.getLevelNumber(), null);
        ClassificationVariant variant = TestUtil.createClassificationVariantFuture(
                "Variant - Tilleggsinndeling for familier", user);
        variant.addClassificationItem(TestUtil.createClassificationItem("C", "Enslig person med barn"), 1, null);
        variant.addClassificationItem(TestUtil.createClassificationItem("CA", "Enslig person med barn 0-5 år"), 2, variant
                .findItem("C"));
        variant.addClassificationItem(TestUtil.createClassificationItem("CB", "Enslig person med barn 6-17 år"), 2, variant
                .findItem("C"));
        version.addClassificationVariant(variant);
        return version;
    }
    ...
    public static CorrespondenceTable createAndAddCorrespondenceTableTableFutureVersion(ClassificationSeries kommuneClassification,
                                                                      ClassificationSeries bydelClassification) {
        ClassificationVersion kommuneFuture = kommuneClassification.getClassificationVersions().get(0);
        ClassificationVersion bydelFuture = bydelClassification.getClassificationVersions().get(0);
        CorrespondenceTable correspondenceTable = TestUtil.createCorrespondenceTable(kommuneFuture, bydelFuture);
        for (String bydelCode : Arrays.asList("030101", "030102", "030103")) {
            correspondenceTable.addCorrespondenceMap(new CorrespondenceMap(kommuneFuture.findItem("0301"), bydelFuture.findItem(
                    bydelCode)));
        }
