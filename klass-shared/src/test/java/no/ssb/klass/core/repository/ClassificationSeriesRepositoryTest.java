...
public class ClassificationSeriesRepositoryTest {
  ...
  public void findAllCodelist() {
    ...
    // then
    assertEquals(
        1, subject.findAll(includeCodelistsSpecification, createPageable()).getTotalElements());
    assertEquals(
        0, subject.findAll(excludeCodelistsSpecification, createPageable()).getTotalElements());
  }
  ...
  public void findAllChangedSince() throws Exception {
    ...
    // then
    assertEquals(
        1, subject.findAll(beforeCreatedSpecification, createPageable()).getTotalElements());
    assertEquals(
  ...
  public void testNumberOfClassifications() {
    ...
    assertEquals(0, result);
    result =
        subject.finNumberOfClassifications(ClassificationType.CLASSIFICATION, user.getSection());
    assertEquals(1, result);
  ...
  public void testNumberOfVersions() {
    ...
    assertEquals(1, result);
    result =
        subject.findNumberOfPublishedVersionsAllLanguages(ClassificationType.CLASSIFICATION, "007");
    assertEquals(0, result);
    result =
        subject.findNumberOfPublishedVersionsAllLanguages(
            ClassificationType.CODELIST, user.getSection());
    ...
    assertEquals(1, result);
    result =
        subject.findNumberOfPublishedVersionsAnyLanguages(ClassificationType.CLASSIFICATION, "007");
    assertEquals(0, result);
    result =
        subject.findNumberOfPublishedVersionsAnyLanguages(
            ClassificationType.CODELIST, user.getSection());
  ...
  public static ClassificationSeries createClassificationSeriesWithVersion(
    ...
    version.addClassificationItem(
        TestUtil.createClassificationItem("0001", "firstItem"), level.getLevelNumber(), null);
    version.addClassificationItem(
        TestUtil.createClassificationItem("0002", "secondItem"), level.getLevelNumber(), null);
  ...
  @EntityScan(
      basePackageClasses = {TranslatablePersistenceConverter.class, ClassificationSeries.class})
