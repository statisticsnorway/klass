...
public class ClassificationFamilyRepositoryTest {
    ...
    private static final Logger logger =
            LoggerFactory.getLogger(ClassificationFamilyRepositoryTest.class);

    @Autowired private ClassificationFamilyRepository subject;
    ...
    public void verifyMapping() {
        ...
        // when
        ClassificationFamily result =
                subject.findById(family.getId())
                        .orElseThrow(() -> new RuntimeException("ClassificationFamily not found"));
    ...
    public void findClassificationFamilySummariesWithMatchingSection() {
        ...
        List<ClassificationFamilySummary> result =
                classificationFamilySummaries.buildPublicClassificationSummaries(
                        section, allClassificationTypes);
    ...
    public void findClassificationFamilySummariesWithMatchingClassificationType() {
        ...
        ClassificationType classificationType =
                family.getClassificationSeries().get(0).getClassificationType();

        List<ClassificationFamilySummary> result =
                classificationFamilySummaries.buildPublicClassificationSummaries(
                        allSections, classificationType);
    ...
    public void findClassificationFamilySummariesOneClassificationIsCopyrightedNotPublic() {
        // This test is for demonstrating why we should test method
        // 'findPublicClassificationFamilySummaries' which
        ...
        // when
        List<ClassificationFamilySummary> result =
                classificationFamilySummaries.buildClassificationSummaries(
                        allSections, allClassificationTypes);
    ...
    public void verifyFindAllClassificationFamiliesBuildSummaries() {
        ...
        ClassificationFamily family = createClassificationFamilyWithOneClassification();
        subject.save(family);
        ClassificationFamily code_family =
                createClassificationFamilyOneClassificationIsCopyrighted();
    ...
    private ClassificationFamily createClassificationFamilyWithOneClassification() {
        ...
        ClassificationVersion version1 =
                TestUtil.createClassificationVersion(DateRange.create("2000-01-01", "2010-01-01"));
        ClassificationVersion version2 =
                TestUtil.createClassificationVersion(DateRange.create("2010-01-01", "2020-01-01"));
        ...
        logger.info(
                LOGGER_MESSAGE_CLASSIFICATION_SERIES,
                family.getClassificationSeries().size(),
                family.getName());
    ...
    private ClassificationFamily createClassificationFamilyOneClassificationIsCopyrighted() {
        ClassificationFamily family =
                subject.save(TestUtil.createClassificationFamily("Code family"));
        ...
        logger.info(
                ...
                family.getName());
        logger.info(
                LOGGER_MESSAGE_CLASSIFICATION_VERSIONS,
                classification.getClassificationVersions().size(),
                family.getName());
    ...
    private ClassificationFamily createClassificationFamilyOneClassificationIsDeleted() {
        ClassificationFamily family =
                subject.save(TestUtil.createClassificationFamily("Winter family"));
    ...
    private ClassificationFamily createClassificationFamilyOneVersionNotPublished() {
        ClassificationFamily family =
                subject.save(TestUtil.createClassificationFamily("Summer family"));
        ClassificationSeries classification = TestUtil.createClassification("july");
        classification.setContactPerson(user);
        family.addClassificationSeries(classification);
        ClassificationVersion version =
                TestUtil.createClassificationVersion(DateRange.create("1999-01-01", "2001-01-01"));
        ClassificationVersion version2 =
                TestUtil.createClassificationVersion(DateRange.create("2010-01-01", "2020-01-01"));
    ...
    private ClassificationFamily createClassificationFamilyOneVersionDeleted() {
        ClassificationFamily family =
                subject.save(TestUtil.createClassificationFamily("Boat family"));
    ...
    private ClassificationFamily createClassificationFamilyNoVersionPublished() {
        ClassificationFamily family =
                subject.save(TestUtil.createClassificationFamily("Skate family"));
    ...
    private final String LOGGER_MESSAGE_CLASSIFICATION_SERIES =
            "Number of classification series: {} for classification family: {}";
    private final String LOGGER_MESSAGE_FAMILIES = "Total number of families: {}";
    private final String LOGGER_MESSAGE_CLASSIFICATION_VERSIONS =
            "Number of classification versions: {} for classification family: {}";

    @Configuration
    @EnableAutoConfiguration
    @EntityScan(
            basePackageClasses = {
                ClassificationFamily.class,
