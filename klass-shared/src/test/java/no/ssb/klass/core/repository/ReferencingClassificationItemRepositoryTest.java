...
public class ReferencingClassificationItemRepositoryTest {
    ...
    public void findByReferenceInList() {
        ...
        List<ReferencingClassificationItem> deletedItemReferences = referencingItemRepository.findByReferenceInList(
                normalVersion.getAllClassificationItems(), true);
        List<ReferencingClassificationItem> normalItemReferences = referencingItemRepository.findByReferenceInList(
