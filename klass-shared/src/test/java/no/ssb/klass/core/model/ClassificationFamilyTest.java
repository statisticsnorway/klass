...
public class ClassificationFamilyTest {
  ...
  public void getClassificationSeriesBySectionAndClassificationType() {
    ...
    assertEquals(
        ...
        getClassificationSeries(
            allSections,
            TestUtil.oppositeClassificationType(classification.getClassificationType())));
    assertEquals(
        1,
        getClassificationSeries(
  ...
  private long getClassificationSeries(String section, ClassificationType classificationType) {
    return subject
        .getClassificationSeriesBySectionAndClassificationType(section, classificationType)
        .size();
  }
}
