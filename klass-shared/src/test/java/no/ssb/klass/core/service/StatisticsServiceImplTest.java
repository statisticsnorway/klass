...
public class StatisticsServiceImplTest {
  ...
  //    }
  //
  //    private void checkClassificationReportDataNotPub(ClassificationReportData<?> result, String
  // section, String name) {
  //        result.reset();
  //        assertEquals(section + '1', result.getSection());
  //        assertEquals(name + "2_NO", result.getName());
  ...
  //        result.add(new ClassificationVersionReportDto(mockClassificationVersion("A", true, true,
  // true),
  ...
  //    }
  //
  //    private List<ClassificationVersionReportDto> makeClassificationVersionData1(String section,
  // String name) {
  //        List<ClassificationVersionReportDto> result = new ArrayList<>(3);
  //        result.add(new ClassificationVersionReportDto(mockClassificationVersion("A", true, true,
  // true),
  ...
  //    }
  //
  //    private ClassificationVersion mockClassificationVersion(String name, boolean pubNo, boolean
  // pubNn, boolean pubEn) {
