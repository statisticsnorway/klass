...
//                searchWordsRepositoryMock, statisticalUnitRepositoryMock, subscriberRepositoryMock);
//    }
//
//    @Test
...
//        ClassificationReportData<?> result = subject.getPublishedReport(section, ClassificationType.CLASSIFICATION,
...
//                .getPublishedReport(section, ClassificationType.CLASSIFICATION, ReportModeChoice.MISSING_LANG);
...
//        Map<ReportDescription<UseStatisticsModeChoice>, Integer> result = subject.getUsageStatistics(getFromDate(),
//                getToDate()).getRows();
...
//        when(classificationAccessCounterRepositoryMock.getClassificationsCount(any(Date.class), any(Date.class), any(
//                PageRequest.class)))
...
//        when(searchWordsRepositoryMock.getSearchWords(anyBoolean(), any(Date.class), any(Date.class), any(
//                PageRequest.class)))
//                        .thenReturn(makeTestData());
//        UsageStatisticsData result = subject.getUsageStatistics(getFromDate(), getToDate(),
...
//        when(searchWordsRepositoryMock.getSearchWords(any(Date.class), any(Date.class), any(PageRequest.class)))
//                .thenReturn(makeTestData());
//        UsageStatisticsData result = subject.getUsageStatistics(getFromDate(), getToDate(),
...
//        ClassificationReportData<ClassificationReportDto> result = subject.getAllClassificationSeriesForStaticalUnit(
//                statisticalUnit);
//        assertEquals(
...
//        result.add(new ClassificationReportDto(mockClassificationSeries(2L, name + "2_NO"), mockUser(section + '1',
//                "Skrue")));
//        result.add(new ClassificationReportDto(mockClassificationSeries(1L, name + "1_NO"), mockUser(section + '1',
//                "Donald")));
//        result.add(new ClassificationReportDto(mockClassificationSeries(3L, name + "3_NO"), mockUser(section + '2',
//                "Skrue")));
//        return result;
//    }
//
