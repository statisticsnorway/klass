...
public class KlassApiClassificationCorrespondsAtXmlTest extends AbstractKlassApiCorrespondsTest {
  ...
  void getOneClassificationCorrespondenceAt() {
    ...
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(path, paramsTargetIdAndDate, APPLICATION_XML);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(path, paramsTargetIdAndDate, APPLICATION_XML);
    ...
    if (sourceResponse.getStatusCode() != 200) {
      ...
      validateXmlList(
          path, sourceResponse, targetResponse, CORRESPONDENCE_ITEM_LIST_CORRESPONDENCE_ITEM);
    }
  }
  ...
  void getClassificationCorrespondsAtLanguageEn() {
    ...
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(
            path, paramsTargetIdAndDateLanguageEn, APPLICATION_XML);
    Response targetResponse =
  ...
  void getClassificationCorrespondsAtLanguageNn() {
    ...
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(
            path, paramsTargetIdAndDateLanguageNn, APPLICATION_XML);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(
            path, paramsTargetIdAndDateLanguageNn, APPLICATION_XML);
  ...
  void getClassificationCorrespondsAtIncludeFuture() {
    ...
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(
            path, paramsTargetIdAndDateIncludeFuture, APPLICATION_XML);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(
            path, paramsTargetIdAndDateIncludeFuture, APPLICATION_XML);
