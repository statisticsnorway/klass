...
public class KlassApiVersionByIdXmlTest extends AbstractKlassApiVersions {
  ...
  void getOneVersionById() {
    ...
    if (sourceResponse.getStatusCode() != 200) {
      ...
      validateXmlList(
          path, sourceResponse, targetResponse, CLASSIFICATION_VERSION_PUBLISHED_LANGUAGES);
      validateXmlList(path, sourceResponse, targetResponse, CLASSIFICATION_VERSION_LEVELS);
      validateXmlList(
          path, sourceResponse, targetResponse, CLASSIFICATION_VERSION_CLASSIFICATION_ITEMS);
