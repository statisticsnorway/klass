...
public abstract class AbstractRestApiApplicationTest {
  ...
  public void prepareTestData() {
    ...
    classificationFamily =
        classificationFamilyRepository.save(TestUtil.createClassificationFamily("Befolkning"));
    ...
    correspondenceTableRepository.save(
        TestDataProvider.createAndAddChangeCorrespondenceTableFutureVersion(kommuneinndeling));
