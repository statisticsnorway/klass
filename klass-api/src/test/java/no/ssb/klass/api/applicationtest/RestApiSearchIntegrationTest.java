...
public class RestApiSearchIntegrationTest extends AbstractRestApiApplicationTest {
    ...
    void setupSearchIndex() throws Exception {
        ...
        opensearchClient
                .indices()
                .create(createRequest, org.opensearch.client.RequestOptions.DEFAULT);
