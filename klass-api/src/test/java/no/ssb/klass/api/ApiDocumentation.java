...
public class ApiDocumentation {
  ...
  @Autowired private ClassificationService classificationServiceMock;
  @Autowired private SearchService searchServiceMock;
  ...
  public void errorExampleXml() throws Exception {
    when(classificationServiceMock.getClassificationSeries(any()))
        .thenThrow(new KlassResourceNotFoundException("Classification not found with id = 99999"));
    this.mockMvc
...
"""));
  ...
  public void errorExampleJson() throws Exception {
    when(classificationServiceMock.getClassificationSeries(any()))
        .thenThrow(new KlassResourceNotFoundException("Classification not found with id = 99999"));
    this.mockMvc
        .perform(getWithContext("/classifications/99999").accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isNotFound())
        .andExpect(
            content()
                .json(
...
"""));
  ...
  public void classificationFamiliesExample() throws Exception {
    when(classificationServiceMock.findPublicClassificationFamilySummaries(
            isNull(), any(ClassificationType.class)))
        .thenReturn(
            Lists.newArrayList(
    ...
    this.mockMvc
        ...
        .andDo(
            this.documentationHandler.document(
                links(halLinks(), linkWithRel("self").description("The current request")),
                relaxedResponseFields(
                    fieldWithPath("_embedded.classificationFamilies")
                        .description("An array of ClassificationFamilies"),
                    fieldWithPath("_embedded.classificationFamilies[].name")
                        .description("ClassificationFamily name"),
                    ...
                    fieldWithPath("_embedded.classificationFamilies[]._links")
                        .description("Link to classificationFamily"),
  ...
  public void classificationFamiliesOptionalParametersExample() throws Exception {
    ...
    this.mockMvc
        .perform(
            getWithContext(
                    "/classificationfamilies?ssbSection=714&includeCodelists=true&language=nb")
        ...
        .perform(
            getWithContext(
                    "/classificationfamilies/"
                        ...
                        + "?ssbSection=714&includeCodelists=true&language=nb")
                .accept(MediaType.APPLICATION_JSON))
        .andDo(
            this.documentationHandler.document(
                queryParameters(
        ...
        .andDo(
            this.documentationHandler.document(
                ...
                relaxedResponseFields(
                    ...
                    fieldWithPath("_embedded.ssbSections[].name")
                        .description("Name of ssb section"),
                    fieldWithPath("_links")
                        .description(
    ...
    this.mockMvc
        ...
        .andDo(
            this.documentationHandler.document(
                ...
                relaxedResponseFields(
                    fieldWithPath("_embedded.classifications")
                    ...
                    fieldWithPath("_embedded.classifications[].lastModified")
                        .description("Last modification time of classification"),
                    fieldWithPath("_embedded.classifications[]._links")
                        .description("Link to classification"),
                    fieldWithPath("_links")
                        .description("<<classifications-links,Links>> to other resources"),
                    fieldWithPath("page")
                        .description(
  ...
  public void searchExample() throws Exception {
    ...
    this.mockMvc
        ...
        .andDo(
            this.documentationHandler.document(
                links(halLinks(), linkWithRel("self").description("The current search")),
                relaxedResponseFields(
                    fieldWithPath("_embedded.searchResults")
                        .description("An array of search results"),
                    fieldWithPath("_embedded.searchResults[].snippet")
                        .description("A line containing match for the words searched"),
                    fieldWithPath("_embedded.searchResults[].searchScore")
                        .description("Represents this classifications relevans for the search"),
                    fieldWithPath("_embedded.searchResults[]._links")
                        .description("Link to classification that matched search"),
                    fieldWithPath("_links")
                        .description("<<search-links,Links>> to other resources"),
                    fieldWithPath("page")
                        .description(
                            "Describes number of classifications returned, see <<_page, page>>"))))
        .andExpect(status().isOk());
  ...
  public void searchOptionalParametersExample() throws Exception {
    ...
    this.mockMvc
        .perform(
            getWithContext(
                    "/classifications/search?query=kommuner&includeCodelists=true&ssbSection=370")
                .accept(MediaType.APPLICATION_JSON))
        .andDo(
            this.documentationHandler.document(
                queryParameters(
        ...
        .andDo(
            this.documentationHandler.document(
                links(
                    ...
                    linkWithRel("codes")
                        .description(
                            "Used for getting codes from the classification, see <<_codes, codes>>"),
                    linkWithRel("codesAt")
                        .description(
                            "Used for getting codes from the classification valid at a specific date, see <<_codesat, codesAt>>"),
                    linkWithRel("variant")
                        .description(
                            "Used for getting codes from a classification variant, see <<_variant, variant>>"),
                    linkWithRel("variantAt")
                        .description(
                            "Used for getting codes from a variant of the classification valid at a specific date, "
                                + "see <<_variantat, variantAt>>"),
                    linkWithRel("corresponds")
                        .description(
                            "Used for getting mappings between two classifications, see <<_corresponds, corresponds>>"),
                    linkWithRel("correspondsAt")
                        .description(
                            "Used for getting mappings between two classifications at a specific date, "
                                + "see <<_correspondsat, correspondsAt>>"),
                    linkWithRel("changes")
                        .description(
                            "Used for getting changes in codes, see <<_changes, changes>>")),
                relaxedResponseFields(
                    fieldWithPath("name").description("Classification name"),
                    fieldWithPath("description").description("Description of classification"),
                    fieldWithPath("primaryLanguage")
                        .description("Primary language for classification"),
                    fieldWithPath("classificationType")
                        .description("Type of classification, Classification or Codelist"),
                    fieldWithPath("copyrighted")
                        .description("If true, classification is copyrighted"),
                    fieldWithPath("includeShortName")
                        .description(
                            "If true, indicates that classificationItems may have shortnames"),
                    fieldWithPath("includeNotes")
                        .description("If true, indicates that classificationItems may have notes"),
                    ...
                    fieldWithPath("statisticalUnits")
                        .description("Statistical units assigned to classification"),
                    fieldWithPath("lastModified")
                        .description("Last time classification has been modified"),
        ...
        .perform(
            getWithContext(
                    "/classifications/"
                        ...
                        + "?language=nb&includeFuture=true")
                .accept(MediaType.APPLICATION_JSON))
        .andDo(
            this.documentationHandler.document(
        ...
        .andDo(
            this.documentationHandler.document(
                ...
                relaxedResponseFields(
                    ...
                    fieldWithPath("lastModified")
                        .description("Time and date the version was last time modified at"),
                    fieldWithPath("published")
                        .description("List of languages the version is published in"),
                    ...
                    fieldWithPath("correspondenceTables")
                        .description("List of correspondence tables for the version"),
                    fieldWithPath("classificationVariants")
                        .description("List of classification variants for the version"),
                    fieldWithPath("changelogs").description("Log og changes"),
                    fieldWithPath("levels").description("List of levels"),
                    fieldWithPath("classificationItems")
  ...
  public void versionsRequestParametersExample() throws Exception {
    ...
    this.mockMvc
        .perform(
            getWithContext(
                    "/versions/" + CLASS_ID_KOMMUNEINNDELING + "?language=nb&includeFuture=true")
                .accept(MediaType.APPLICATION_JSON))
        .andDo(
            this.documentationHandler.document(
                queryParameters(languageDescription(), includeFutureDescription(""))))
  ...
  public void codesAtExampleCsv() throws Exception {
    ...
    this.mockMvc
        .perform(
            getWithContext(
                    "/classifications/" + CLASS_ID_FYLKEINNDELING + "/codesAt?date=2020-01-01")
        ...
        .andDo(
            this.documentationHandler.document(
                ...
                relaxedResponseFields(
                    ...
                    fieldWithPath("contactPerson")
                        .description("Contact information to the SSB section representative"),
                    fieldWithPath("owningSection").description("SSB section number"),
                    fieldWithPath("lastModified")
                        .description("Time and date the variant was last time modified at"),
                    fieldWithPath("published")
                        .description("List of languages the version is published in"),
                    ...
                    fieldWithPath("correspondenceTables")
                        .description("List of correspondence tables for the variant"),
        ...
        .perform(
            getWithContext(
                    "/classifications/"
                        ...
                        + "/correspondsAt?targetClassificationId="
                        + CLASS_ID_BYDELSINNDELING
                        + "&date=2016-01-01&csvSeparator=;&csvFields=sourceCode,sourceName"
                        + "&language=nb&includeFuture=true")
                .accept("text/csv"))
        .andDo(
            this.documentationHandler =
            ...
            this.documentationHandler.document(
                ...
                relaxedResponseFields(
                    ...
                    fieldWithPath("source")
                        .description("Name to the source classification version"),
                    fieldWithPath("sourceId")
                        .description("ID to the source classification version"),
                    fieldWithPath("target")
                        .description("Name to the target classification version"),
                    fieldWithPath("targetId")
                        .description("ID to the target classification version"),
                    fieldWithPath("changeTable").description("Changes done to the table"),
                    fieldWithPath("lastModified")
                        .description("Timestamp for the last modifications done to the table"),
                    fieldWithPath("published")
                        .description(
                            "A list of the languages the correspondence table is published in"),
                    fieldWithPath("sourceLevel")
                        .description("Level name and number for the source classification version"),
                    fieldWithPath("targetLevel")
                        .description("Level name and number for the target classification version"),
                    fieldWithPath("description").description("Description"),
                    fieldWithPath("changelogs")
                        .description("A list of the changes done to the correspondence table"),
                    fieldWithPath("correspondenceMaps")
                        .description("A list of the mappings the correspondence table includes"),
                    fieldWithPath("_links")
                        .description(
    ...
    this.mockMvc
        .perform(
            getWithContext(
                    "/classifications/"
                        + CLASS_ID_KOMMUNEINNDELING
                        + "/changes?from=2020-01-01&to=2021-01-01")
                .accept("text/csv"))
        .andDo(
            this.documentationHandler =
                document(
        ...
        .perform(
            getWithContext(
                    "/classifications/"
                        ...
                        + "/codes?from=2020-01-01&to=2021-01-01&selectLevel=2")
                .accept("text/csv"))
        .andDo(
            this.documentationHandler =
                document(
    ...
    this.mockMvc
        .perform(
            getWithContext(
                    "/classifications/"
                        + CLASS_ID_KOMMUNEINNDELING
                        + "/codes?from=2019-01-01&to=2020-01-01")
                .accept("text/csv"))
        .andDo(
            this.documentationHandler =
                document(
            ...
            this.documentationHandler.document(
                ...
                relaxedResponseFields(
                    ...
                    fieldWithPath("page.size")
                        .description("Size of a page (number of elements per page)"),
  ...
  private ParameterDescriptor includeCodelistsDescription() {
    return parameterWithName("includeCodelists")
        .description("[Optional] include ssb codelists. Default is false.");
  }

  private ParameterDescriptor languageDescription() {
    return parameterWithName("language")
        .description(
  ...
  private ParameterDescriptor changedSinceDescription() {
    return parameterWithName("changedSince")
        .description(
  ...
  private ParameterDescriptor toParameterDescription() {
    return parameterWithName("to")
        .description(
            "[Optional] specifies end of range with format `<yyyy-MM-dd>`. "
                + "If not set means that to is indefinite. For details see <<_range, range>>");
  }

  private ParameterDescriptor dateParameterDescription() {
    return parameterWithName("date")
        .description("[Mandatory] specifies codes at a certain date with format `<yyyy-MM-dd>`.");
  }

  private ParameterDescriptor targetClassificationIdParameterDescription() {
    return parameterWithName("targetClassificationId")
        .description("[Mandatory] specifies id of target classification");
  }

  private ParameterDescriptor variantNameParameterDescription() {
    return parameterWithName("variantName")
        .description(
  ...
  private ParameterDescriptor csvSeparatorParameterDescription() {
    return parameterWithName("csvSeparator")
        .description(
  ...
  private ParameterDescriptor csvFieldsParameterDescription() {
    return parameterWithName("csvFields")
        .description(
  ...
  private ParameterDescriptor selectCodesParameterDescription() {
    return parameterWithName("selectCodes")
        .description(
  ...
  private ParameterDescriptor selectLevelParameterDescription() {
    return parameterWithName("selectLevel")
        .description(
  ...
  private ParameterDescriptor ssbSectionParameterDescription(String part) {
    return parameterWithName("ssbSection")
        .description(
            "[Optional] only include classifications belonging to specified SSB section when "
                + part
  ...
  private ParameterDescriptor includeCodelistsParameterDescription(String part) {
    return parameterWithName("includeCodelists")
        .description(
            "[Optional] include codelists when " + part + " classifications. Default is false");
  }

  private ParameterDescriptor includeFutureDescription(String part) {
    return parameterWithName("includeFuture")
        .description(
            String.format(
  ...
  public MockHttpServletRequestBuilder getWithContext(String urlTemplate, Object... urlVariables) {
  ...
  private Page<ClassificationSeries> createPage(
      Pageable pageable, List<ClassificationSeries> classifications) {
  ...
  private CodeDto createCode(
      int levelNumber, String code, String officialName, DateRange dateRange) {
    return new CodeDto(
        TestUtil.createLevel(levelNumber),
  ...
  private CorrespondenceDto createCorrespondence(
      String sourceCode,
      String sourceName,
      String targetCode,
      String targetName,
  ...
  private ClassificationSeries createClassificationKommuneinndeling() {
    ClassificationSeries classification =
        TestUtil.createClassificationWithId(
            CLASS_ID_KOMMUNEINNDELING,
    ...
    version2014.addClassificationItem(
        TestUtil.createClassificationItem("1739", "Raarvihke Røyrvik"),
    ...
    version2012.addClassificationItem(
        TestUtil.createClassificationItem("0101", "Halden"), level2012.getLevelNumber(), null);
    version2012.addClassificationItem(
        TestUtil.createClassificationItem("0104", "Moss"), level2012.getLevelNumber(), null);
    version2012.addClassificationItem(
        TestUtil.createClassificationItem("0301", "Oslo"), level2012.getLevelNumber(), null);
    version2012.addClassificationItem(
        TestUtil.createClassificationItem("1739", "Røyrvik"), level2012.getLevelNumber(), null);
    version2012.addClassificationItem(
        TestUtil.createClassificationItem("1939", "Storfjord"), level2012.getLevelNumber(), null);

    classification.addClassificationVersion(version2012);

    CorrespondenceTable correspondenceTable =
        TestUtil.createCorrespondenceTable(version2014, version2012);
    version2014.addCorrespondenceTable(correspondenceTable);
    correspondenceTable.addCorrespondenceMap(
        new CorrespondenceMap(version2014.findItem("1739"), version2012.findItem("1739")));
    correspondenceTable.addCorrespondenceMap(
        new CorrespondenceMap(version2014.findItem("1939"), version2012.findItem("1939")));
  ...
  private ClassificationSeries createClassificationBydelsinndeling() {
    ...
    ClassificationVersion version =
        TestUtil.createClassificationVersion(DateRange.create("2004-01-01", null));
    Level level = TestUtil.createLevel(1);
    version.addLevel(level);
    version.addClassificationItem(
        TestUtil.createClassificationItem("030101", "Gamle Oslo"), level.getLevelNumber(), null);
    version.addClassificationItem(
        TestUtil.createClassificationItem("030102", "Grünerløkka"), level.getLevelNumber(), null);
    version.addClassificationItem(
        TestUtil.createClassificationItem("030103", "Sagene"), level.getLevelNumber(), null);
    version.addClassificationItem(
        TestUtil.createClassificationItem("030104", "St. Hanshaugen"),
        level.getLevelNumber(),
        null);
    version.addClassificationItem(
        TestUtil.createClassificationItem("030105", "Frogner"), level.getLevelNumber(), null);
  ...
  private ClassificationSeries createClassificationFamiliegruppering(User user) {
    ...
    ClassificationVersion version =
        TestUtil.createClassificationVersion(DateRange.create("2006-01-01", null));
    Level level = TestUtil.createLevel(1);
    version.addLevel(level);
    version.addClassificationItem(
        ...
        null);
    ClassificationVariant variant =
        TestUtil.createClassificationVariant("Variant - Tilleggsinndeling for familier", user);
    variant.setId(1111L);
    ...
    variant.addClassificationItem(
        TestUtil.createClassificationItem("A_", "Enpersonfamilie"), 2, variant.findItem("A"));
    variant.addClassificationItem(
  ...
  private CorrespondenceTable createCorrespondenceTable(Long id) {
    CorrespondenceTable table =
        TestUtil.createCorrespondenceTable(
            "Mapping Arbeidsgiveravgiftssoner - Kommuneinndeling",
            TestUtil.createClassificationVersionWithTable(
                CLASS_VARIANT_POLITIDISTRIKT, TestUtil.anyDateRange(), "Arbeidsgiveravgiftssoner"),
            TestUtil.createClassificationVersionWithTable(
                CLASS_VARIANT_KOMMUNEINNDELING, TestUtil.anyDateRange(), "Kommuneinndeling"));
    table.setId(id);
