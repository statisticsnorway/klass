...
public class ApiDocumentation {
    ...
    public void classificationFamiliesExample() throws Exception {
        ...
        this.mockMvc
                .perform(
                        getWithContext("/classificationfamilies")
        ...
        verify(classificationServiceMock)
                .findPublicClassificationFamilySummaries(
                        isNull(), eq(ClassificationType.CLASSIFICATION));
    }
                ...
                .andDo(
                        this.documentationHandler.document(
                                links(
                                        ...
                                        linkWithRel("self").description("The current request")),
                                relaxedResponseFields(
                                        fieldWithPath("_embedded.ssbSections")
                                                .description("Array of ssb sections"),
                ...
                .andDo(
                        this.documentationHandler.document(
                                links(
                                        ...
                                        linkWithRel("self").description("The current request"),
                                        linkWithRel("search")
                                                .description("Link to search for classifications")),
                                relaxedResponseFields(
                                        ...
                                        fieldWithPath("_links")
                                                .description(
                                                        "<<classifications-links,Links>> to other resources"),
                                        fieldWithPath("page")
                                                .description(
                ...
                .andDo(
                        this.documentationHandler.document(
                                ...
                                relaxedResponseFields(
                                        ...
                                        fieldWithPath("_links")
                                                .description(
                                                        "<<search-links,Links>> to other resources"),
                                        fieldWithPath("page")
                                                .description(
                                                        "Describes number of classifications returned, see <<_page, page>>"))))
                .andExpect(status().isOk());
                        ...
                        this.documentationHandler.document(
                                requestParameters(
                                        parameterWithName("query")
                                                .description("[Mandatory] specifies search terms"),
                        ...
                        this.documentationHandler.document(
                                ...
                                relaxedResponseFields(
                                        ...
                                        fieldWithPath("contactPerson")
                                                .description("Contact person for classification"),
                                        fieldWithPath("owningSection")
                                                .description("Owning SSB section"),
    ...
    public void classificationOptionalParametersExample() throws Exception {
        ...
        this.mockMvc
                ...
                .andDo(
                        this.documentationHandler.document(
                                requestParameters(
                                        languageDescription(), includeFutureDescription(""))))
                .andExpect(status().isOk());
        // @formatter:on
    }
    ...
    public void versionsExampleJson() throws Exception {
        ...
        when(classificationServiceMock.getClassificationVersion(any(Long.class)))
                .thenReturn(version);
        // @formatter:off
        this.mockMvc
                .perform(
                ...
                .andDo(
                        this.documentationHandler.document(
                                ...
                                relaxedResponseFields(
                                        ...
                                        fieldWithPath("validFrom")
                                                .description("Date the version is valid from"),
                                        fieldWithPath("validTo")
                                                .description("Date the version is valid to"),
                                        fieldWithPath("lastModified")
                                                .description(
    ...
    public void codesAtExampleCsv() throws Exception {
        ...
        this.mockMvc
                .perform(
                        getWithContext(
                                        "/classifications/"
                                                + CLASS_ID_FYLKEINNDELING
                                                + "/codesAt?date=2020-01-01")
    ...
    public void variantsExampleJson() throws Exception {
        ClassificationVariant variant =
                createClassificationFamiliegruppering(TestUtil.createUser())
                        ...
                        .get(0);
        when(classificationServiceMock.getClassificationVariant(any(Long.class)))
                .thenReturn(variant);
        // @formatter:off
        this.mockMvc
                ...
                .andDo(
                        this.documentationHandler.document(
                                ...
                                relaxedResponseFields(
                                        ...
                                        fieldWithPath("owningSection")
                                                .description("SSB section number"),
                                        fieldWithPath("lastModified")
                                                .description(
                                        ...
                                        fieldWithPath("published")
                                                .description(
                                                        "List of languages the version is published in"),
                                        fieldWithPath("validFrom")
                                                .description("Date the variant is valid from"),
                                        fieldWithPath("validTo")
                                                .description("Date the variant is valid to"),
                                        fieldWithPath("introduction")
        ...
        this.mockMvc
                .perform(
                        getWithContext("/variants/" + 1111L + "?language=nb")
                                .accept(MediaType.APPLICATION_JSON))
                .andDo(this.documentationHandler.document(requestParameters(languageDescription())))
                .andExpect(status().isOk());
        // @formatter:on
    }
    ...
    public void correspondsExample() throws Exception {
        DateRange dateRange = DateRange.create("2020-01-01", "2021-01-01");
        when(classificationServiceMock.findCorrespondences(
        ...
        this.mockMvc
                ...
                .andDo(
                        this.documentationHandler.document(
                                ...
                                relaxedResponseFields(
                                        fieldWithPath("name")
                                                .description("Correspondence table's name"),
                                        fieldWithPath("contactPerson")
                                                .description(
                                                        "Contact information to the SSB section representative"),
                                        fieldWithPath("owningSection")
                                        ...
                                        fieldWithPath("changeTable")
                                                .description("Changes done to the table"),
                                        fieldWithPath("lastModified")
                                                .description(
    ...
    public void pageExample() throws Exception {
        List<ClassificationSeries> classifications =
                Lists.newArrayList(
                        ...
                        createClassificationFamiliegruppering(TestUtil.createUser()));
        when(classificationServiceMock.findAllPublic(
                        any(Boolean.class), isNull(), any(Pageable.class)))
                .then(i -> createPage(i.getArgument(2, Pageable.class), classifications));

        // @formatter:off
        this.mockMvc
                .perform(
                        getWithContext("/classifications?size=2")
                                .accept(MediaType.APPLICATION_JSON))
                .andDo(
                        this.documentationHandler.document(
                                links(
    ...
    private ParameterDescriptor includeFutureDescription(String part) {
        return parameterWithName("includeFuture")
                .description(
                        String.format(
                                "[Optional] include %s future versions if available. Default is false.",
                                part));
    }
    ...
    public MockHttpServletRequestBuilder getWithContext(
    ...
    private Page<SolrSearchResult> createSearchPage(Pageable pageable) {
        ...
        SolrResultPage page =
                new SolrResultPage(Lists.newArrayList(searchResult), pageable, 1, 1.0f);
        HighlightEntry<SolrSearchResult> highlightResult = new HighlightEntry<>(searchResult);
        highlightResult.addSnipplets(
                "Description",
                Lists.newArrayList("Kommuneinndelingen er en administrativ inndeling av Norge"));
    ...
    private List<CorrespondenceDto> createKommuneToBydelCorrespondences(DateRange dateRange) {
        ...
        correspondences.add(
                createCorrespondence("0301", "Oslo", "030101", "Gamle Oslo", dateRange));
        ...
        correspondences.add(
                createCorrespondence("1201", "Bergen", "120102", "Bergenhus", dateRange));
        ...
        CorrespondenceTable table =
                TestUtil.createCorrespondenceTable(
                        ...
                        TestUtil.createClassificationVersionWithTable(
                                CLASS_VARIANT_POLITIDISTRIKT,
                                TestUtil.anyDateRange(),
                                "Arbeidsgiveravgiftssoner"),
                        TestUtil.createClassificationVersionWithTable(
                                CLASS_VARIANT_KOMMUNEINNDELING,
                                TestUtil.anyDateRange(),
                                "Kommuneinndeling"));
        table.setId(id);
