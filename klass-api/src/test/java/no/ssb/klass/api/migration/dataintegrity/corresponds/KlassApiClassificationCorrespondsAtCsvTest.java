...
public class KlassApiClassificationCorrespondsAtCsvTest extends AbstractKlassApiCorrespondsTest {
  ...
  void getClassificationCorrespondsAtLanguageEn() {
    ...
    String path = getCorrespondsAtPath(classificationId);
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(path, paramsTargetIdAndDateLanguageEn, TEXT_CSV);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(path, paramsTargetIdAndDateLanguageEn, TEXT_CSV);
  ...
  void getClassificationCorrespondsAtLanguageNn() {
    ...
    String path = getCorrespondsAtPath(classificationId);
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(path, paramsTargetIdAndDateLanguageNn, TEXT_CSV);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(path, paramsTargetIdAndDateLanguageNn, TEXT_CSV);
  ...
  void getClassificationCorrespondsAtCsvSeparator() {
    ...
    String path = getCorrespondsAtPath(classificationId);
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(path, paramsTargetIdAndDateCsvSeparator, TEXT_CSV);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(path, paramsTargetIdAndDateCsvSeparator, TEXT_CSV);
  ...
  void getClassificationCorrespondsAtCsvFields() {
    ...
    String path = getCorrespondsAtPath(classificationId);
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(path, paramsTargetIdAndDateCsvFields, TEXT_CSV);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(path, paramsTargetIdAndDateCsvFields, TEXT_CSV);
