...
public class KlassApiClassificationVariantXmlTest extends AbstractKlassApiVariantTest {
  ...
  void getOneClassificationVariant() {
    ...
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(path, paramsVariantDateFrom, APPLICATION_XML);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(path, paramsVariantDateFrom, APPLICATION_XML);
