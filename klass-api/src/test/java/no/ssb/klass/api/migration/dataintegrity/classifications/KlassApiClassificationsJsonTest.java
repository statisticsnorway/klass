...
public class KlassApiClassificationsJsonTest extends AbstractKlassApiClassifications {
  ...
  void getClassificationsIncludeCodeLists() {
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(
            CLASSIFICATIONS_PATH, paramsIncludeCodeLists, null);
    Response targetResponse =
  ...
  void getClassificationsChangedSince() {
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(CLASSIFICATIONS_PATH, paramsChangedSince, null);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(CLASSIFICATIONS_PATH, paramsChangedSince, null);
