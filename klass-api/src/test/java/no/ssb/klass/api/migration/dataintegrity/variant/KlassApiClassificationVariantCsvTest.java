...
public class KlassApiClassificationVariantCsvTest extends AbstractKlassApiVariantTest {
    ...
    void getOneClassificationVariant() {
        ...
        Response sourceResponse =
                klassApiMigrationClient.getFromSourceApi(path, paramsVariantDateFrom, TEXT_CSV);
        Response targetResponse =
                klassApiMigrationClient.getFromTargetApi(path, paramsVariantDateFrom, TEXT_CSV);
