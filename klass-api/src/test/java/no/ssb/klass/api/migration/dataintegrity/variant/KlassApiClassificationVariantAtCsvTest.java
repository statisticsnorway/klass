...
public class KlassApiClassificationVariantAtCsvTest extends AbstractKlassApiVariantTest {
    ...
    void getOneClassificationVariantAt(){
        ...
        Response sourceResponse = klassApiMigrationClient.getFromSourceApi(path, paramsVariantDate,TEXT_CSV);
        Response targetResponse = klassApiMigrationClient.getFromTargetApi(path, paramsVariantDate,TEXT_CSV);
