...
//                .param("language", "nb")
                ...
                .statusCode(HttpStatus.OK.value())
                .body(XML_CORRESPONDENCETABLE + ".name", is("Kommuneinndeling 2014 - Bydelsinndeling 2014"))
                ...
                .body(XML_CORRESPONDENCETABLE + ".sourceId", is(String.valueOf(correspondenceTable.getSource().getId().intValue())))
                .body(XML_CORRESPONDENCETABLE + ".target", is("Bydelsinndeling 2014"))
                .body(XML_CORRESPONDENCETABLE + ".targetId", is(String.valueOf(correspondenceTable.getTarget().getId().intValue())))
