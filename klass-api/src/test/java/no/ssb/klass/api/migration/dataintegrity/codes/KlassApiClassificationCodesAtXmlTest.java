...
public class KlassApiClassificationCodesAtXmlTest extends AbstractKlassApiCodesTest {
  ...
  void getOneClassificationCodesAt() {
    ...
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(path, paramDate, APPLICATION_XML);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(path, paramDate, APPLICATION_XML);
  ...
  void getClassificationCodesAtLanguageEn() {
    ...
    String path = getCodesAtPath(classificationId);
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(path, paramsLanguageEnAt, APPLICATION_XML);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(path, paramsLanguageEnAt, APPLICATION_XML);
  ...
  void getClassificationCodesAtLanguageNn() {
    ...
    String path = getCodesAtPath(classificationId);
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(path, paramsLanguageNnAt, APPLICATION_XML);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(path, paramsLanguageNnAt, APPLICATION_XML);
  ...
  void getClassificationCodesAtIncludeFuture() {
    ...
    String path = getCodesAtPath(classificationId);
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(path, paramsIncludeFutureAt, APPLICATION_XML);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(path, paramsIncludeFutureAt, APPLICATION_XML);
  ...
  void getClassificationCodesAtSelectCode() {
    ...
    String path = getCodesAtPath(classificationId);
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(path, paramsSelectCodeAt, APPLICATION_XML);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(path, paramsSelectCodeAt, APPLICATION_XML);
  ...
  void getClassificationCodesAtSelectCodes() {
    ...
    String path = getCodesAtPath(classificationId);
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(path, paramsSelectCodesAt, APPLICATION_XML);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(path, paramsSelectCodesAt, APPLICATION_XML);
  ...
  void getClassificationCodesAtSelectLevel() {
    ...
    String path = getCodesAtPath(classificationId);
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(path, paramsSelectLevelAt, APPLICATION_XML);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(path, paramsSelectLevelAt, APPLICATION_XML);
  ...
  void getClassificationCodesAtPresentationPattern() {
    ...
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(
            path, paramsPresentationCodePatternAt, APPLICATION_XML);
    Response targetResponse =
