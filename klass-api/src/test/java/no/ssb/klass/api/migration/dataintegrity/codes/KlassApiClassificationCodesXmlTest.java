...
public class KlassApiClassificationCodesXmlTest extends AbstractKlassApiCodesTest {
  ...
  void getOneClassificationWithCodes() {
    ...
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(path, paramsFrom, APPLICATION_XML);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(path, paramsFrom, APPLICATION_XML);
  ...
  void getClassificationWithCodesIncludeFuture() {
    ...
    String path = getCodesPath(classificationId);
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(path, paramsIncludeFuture, APPLICATION_XML);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(path, paramsIncludeFuture, APPLICATION_XML);
  ...
  void getClassificationWithCodesSelectCode() {
    ...
    String path = getCodesPath(classificationId);
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(path, paramsSelectCode, APPLICATION_XML);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(path, paramsSelectCode, APPLICATION_XML);
  ...
  void getClassificationWithCodesPresentationPattern() {
    ...
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(
            path, paramsPresentationCodePattern, APPLICATION_XML);
    Response targetResponse =
