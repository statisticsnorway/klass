...
public class CorrespondenceItemListTest {
    ...
    public void mergeTest() {
        ...
        List<RangedCorrespondenceItem> items =
                Arrays.asList(
                        new RangedCorrespondenceItem(
                                item, DateRange.create("2010-01-01", "2011-01-01")),
                        new RangedCorrespondenceItem(
                                item, DateRange.create("2006-01-01", "2007-01-01")),
                        new RangedCorrespondenceItem(
                                item, DateRange.create("2007-01-01", "2008-01-01")),
                        new RangedCorrespondenceItem(
                                item, DateRange.create("2012-01-01", "2013-01-01")),
                        new RangedCorrespondenceItem(
                                item, DateRange.create("2013-01-01", "2014-01-01")),
        ...
        // then
        assertEquals(
                result.get(0).getDateRange(true), DateRange.create("2006-01-01", "2008-01-01"));
        assertEquals(
                result.get(1).getDateRange(false), DateRange.create("2010-01-01", "2011-01-01"));
