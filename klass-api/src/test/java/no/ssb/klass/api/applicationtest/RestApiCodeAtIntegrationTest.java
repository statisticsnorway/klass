...
public class RestApiCodeAtIntegrationTest extends AbstractRestApiApplicationTest {
  ...
  /**
   * NOTE: different behavior between "csvSeparator" and non "csvSeparator" requests, csvSeparator
   * requests wraps values with quotes while the normal one does not. May want make a standard for
   * this.
   */
  @Test
