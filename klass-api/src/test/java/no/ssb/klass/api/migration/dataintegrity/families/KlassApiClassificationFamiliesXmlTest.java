...
public class KlassApiClassificationFamiliesXmlTest extends AbstractKlassApiFamiliesTest {
  ...
  void getClassificationFamilies() {
    ...
    if (sourceResponse.getStatusCode() != 200) {
      ...
      validatePathListWithObjectsXml(
          sourceResponse,
          targetResponse,
          ENTITIES_CONTENTS_CONTENT,
          pathNamesClassificationFamiliesXml);
  ...
  void getClassificationFamiliesIncludeCodeLists() {
    ...
    String path = getClassificationFamiliesPath();
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(path, paramsIncludeCodeLists, APPLICATION_XML);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(path, paramsIncludeCodeLists, APPLICATION_XML);
