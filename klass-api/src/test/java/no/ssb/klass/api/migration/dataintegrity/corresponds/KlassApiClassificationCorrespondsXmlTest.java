...
public class KlassApiClassificationCorrespondsXmlTest extends AbstractKlassApiCorrespondsTest {
  ...
  void getOneClassificationCorrespondence() {
    ...
    Response sourceResponse =
        klassApiMigrationClient.getFromSourceApi(path, paramsTargetIdAndDateFrom, APPLICATION_XML);
    Response targetResponse =
        klassApiMigrationClient.getFromTargetApi(path, paramsTargetIdAndDateFrom, APPLICATION_XML);
