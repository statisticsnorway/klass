...
class CodeListTest {
  ...
  class FilterOnCodes {
    ...
    void setUp() {
      baseList =
          makeCodeList(
              "1000", "1100", "1111", "1199", "1200", "3000", "3004", "3006", "3100", "3200",
              "3399", "3400", "3410", "3499", "3500");
    ...
    class SpecifiedCases {
      ...
      void whitespaceAndEmptyValues(String input) {
        ...
        if (input.contains("3004") || input.contains("3499")) {
          assertThat(output.getCodes()).extracting(CodeItem::getCode).containsAnyOf("3004", "3499");
        } else {
          assertThat(output.getCodes())
              .extracting(CodeItem::getCode)
              .containsExactlyInAnyOrderElementsOf(baseCodes);
      ...
      void numericRangeAndWildcard() {
        ...
        assertThat(output.getCodes())
            ...
            .containsExactlyInAnyOrder(
                "3004", "3006", "3100", "3200", "3399", "3400", "1100", "1111", "1199");
        assertThat(output).isNotSameAs(baseList);
      }
    ...
    class Validation {
      ...
      @ValueSource(
          strings = {
            "a", "bcd", "2001.", "2002/", "2003\\", "2004:", "2005;", "2006|", "2007+", "2 O O 8",
            "2009😆", "3001?", "3002=", "3003&", "3004%", "3005!", "3006@"
          })
  ...
  class CombineCodeItems {
    ...
    void merges_back_to_back_intervals_into_one() {
      ...
      assertThat(result.get(0).getValidFromInRequestedRange()).isEqualTo(LocalDate.of(2000, 1, 1));
      assertThat(result.get(0).getValidToInRequestedRange()).isEqualTo(LocalDate.of(2010, 1, 1));
    }
