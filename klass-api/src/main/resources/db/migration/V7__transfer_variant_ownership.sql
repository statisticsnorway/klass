...
UPDATE
    klass.statistical_classification AS cs
SET
    contact_person_id = m.correct_user_id
FROM
    user_mapping m
WHERE
    cs.contact_person_id = m.duplicate_user_id
  AND cs.dtype = 'variant';