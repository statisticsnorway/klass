...
e.g. json: http://data.ssb.no/api/klass/v1/classifications/104/codesAt.json?date=2020-01-01[http://data.ssb.no/api/klass/v1/classifications/104/codesAt.json?date=2020-01-01]. Be aware that you then get the default character sets. 

=== License
We use the Norwegian Licence for Open Government Data, [NLOD](https://data.norge.no/nlod/en/), which is compatible to Creative Commons 4.0 Attribution (CC BY 4.0).
...
To navigate to the target or the source classification version use <<correspondence-tables-links,links>> specified in the JSON or XML response. The ID is shown under versions.
