...
== Overview
=== Rest Client
Examples in this documentation use https://en.wikipedia.org/wiki/CURL[curl]. The -i parameter in the examples includes the HTTP response headers. Be aware that when running Curl on MS Windows all single ' have to be replaced by double ". If Curl is unknown, an alternative is
to use a Rest client to explore Klass Rest interface, like https://www.getpostman.com/product/api-client[Postman].

In many cases it is possible to get output in the supported formats without using Curl -H. Add the dot-prefix .json, .csv or .xml in the URL before the request parameters.
...
include::{snippets}/classifications-example/http-request.adoc[]
...
===== Example request (json)
include::{snippets}/search-example/http-request.adoc[]
...
===== Example request (json)
include::{snippets}/classification-example/http-request.adoc[]
...
include::{snippets}/codes-example/http-request.adoc[]
...
include::{snippets}/codes-at-example/http-request.adoc[]
...
=== Versions by ID
Used to get a classification variant by ID. Use `includeFeature` flag in the request to also list variants and correspondencetables that are not valid yet.
...
include::{snippets}/versions-example-json/http-request.adoc[]
...
===== Example request (CSV with ISO-8859-1)
include::{snippets}/versions-example-csv/http-request.adoc[]
...
===== Example request (csv with UTF-8)
include::{snippets}/variant-example/http-request.adoc[]
...
===== Example request (csv with ISO-8859-1)
include::{snippets}/variant-at-example/http-request.adoc[]
...
===== Example request (JSON with UTF-8)
include::{snippets}/variants-example-json/http-request.adoc[]
...
===== Example request (CSV with ISO-8859-1)
include::{snippets}/variants-example-csv/http-request.adoc[]
...
===== Example request (csv with UTF-8)
include::{snippets}/corresponds-example/http-request.adoc[]
...
===== Example request (csv with UTF-8)
include::{snippets}/corresponds-at-example/http-request.adoc[]
...
===== Example request (csv with ISO-8859-1)
include::{snippets}/correspondence-tables-example-csv/http-request.adoc[]

===== Example response (csv with ISO-8859-1)
include::{snippets}/correspondence-tables-example-csv/http-response.adoc[]

===== Example request (JSON with UTF-8)
include::{snippets}/correspondence-tables-example-json/http-request.adoc[]
...
===== Example request (csv with ISO-8859-1)
include::{snippets}/changes-example/http-request.adoc[]
...
===== Example request (json)
include::{snippets}/classification-families-example/http-request.adoc[]
...
===== Example request (json)
include::{snippets}/classification-family-example/http-request.adoc[]
...
===== Example request (json)
include::{snippets}/ssb-sections-example/http-request.adoc[]
...
=== versions
Used to get codes from a classification or code list version. The response for each code indicates the valid range (validFrom/validTo). Unfortunately does not the response give which classificiation the version is part of.
...
include::{snippets}/range-example/http-request.adoc[]
...
include::{snippets}/range-extended-example/http-request.adoc[]
...
===== Example
include::{snippets}/changed-since-example/http-request.adoc[]
...
|===
| |Codes selected
| selectCodes = 3004| Only 0104
| selectCodes = 3004, 3006 | Only 0104 and 0106
| selectCodes = 3004, 11* | 0104 and all starting with 11
...
include::{snippets}/select-codes-example/http-request.adoc[]
...
include::{snippets}/csv-separator-example/http-request.adoc[]
===== Example response
...
include::{snippets}/language-example/http-request.adoc[]
===== Example response
...
include::{snippets}/select-level-example/http-request.adoc[]
===== Example response
...
include::{snippets}/presentation-name-pattern-example/http-request.adoc[]
...
===== Example request
include::{snippets}/page-example/http-request.adoc[]
