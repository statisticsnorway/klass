...
public final class ResourceUtil {
    ...
    public static UriTemplate createUriTemplate(
            WebMvcLinkBuilder linkBuilder, String... parameters) {
        String baseUri =
                linkBuilder.toUriComponentsBuilder().replaceQuery(null).build().toUriString();
    ...
    private static TemplateVariables createParameters(String... parameters) {
        ...
        for (String parameter : parameters) {
            templateVariables.add(
                    new TemplateVariable(parameter, TemplateVariable.VariableType.REQUEST_PARAM));
        }
